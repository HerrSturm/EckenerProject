...
# Variabeln fuer Farben werden kreiert
brown = (150,80,50)
blue = (80,150,255)
green = (50,100,50)
...
# Alle Bloecke werden mit Groesse, Position und Farbe kreiert (Vec2)
...
while True:
    ...
    # Bloecke und Character werden bei jedem Schleifendruchlauf geupdatet und gedrawt
    ...
    # Keybinds fuer Bewegung des Characters nach links (A) und nach rechts (D) festgelegt
    ...
    # Ruft update auf CollisionManager auf -> bewegt HitBoxen, prueft Kollisionen
